! function(t) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var a = [{ min: 1, max: 3, text: "운이 좋았군요. 너무 자만하지 마세요" }, { min: 2, max: 4, text: "운이 좋았군요, 밤을 새지 않고 성공하다니.." }, { min: 1, max: 2, text: "멈추지 말고, 계속 도전하세요." }, { min: 2, max: 5, text: "이 패턴은 너무 강력한 규칙이 숨겨져 있었어요." }, { min: 1, max: 4, text: "당신의 뇌의 잠재력이 발휘되지 않았군요.." }, { min: 2, max: 5, text: "당신의 점수를 자랑할 건 아니죠?" }, { min: 8, max: 10, text: "휴, 십년감수했네요. 성공하는 줄 알았어요" }, { min: 4, max: 8, text: "음, 꽤 운이 좋았군요." }, { min: 7, max: 10, text: "좋아요!" }, { min: 9, max: 10, text: "당신이 해냈어요!" }, { min: 11, max: 50, text: "무작정 시도하는 건 좋은 전략이 아닙니다." }, { min: 11, max: 50, text: "아주 치열한 게임이었어요." }, { min: 11, max: 50, text: "당신은 성공했습니다." }, { min: 11, max: 50, text: "당신은 지금쯤 이 게임을 싫어하게 될 것입니다." }, { min: 11, max: 50, text: "전 당신이 절 속이지 않았길 바라요.." }, { min: 41, max: 403, text: "당신의 노력이 빛났어요." }, { min: 404, max: 404, text: "로직을 찾을 수 없었군요.." }, { min: 405, max: 999, text: "음... 노 코멘트" }],
